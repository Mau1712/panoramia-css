...
export const AboutUsBannerElement = styled.section`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
...
export const AboutUsBannerMediaElement = styled.img`
  position: absolute;
  inset: 0;
  width: 100%;
  height: 100%;
...
export const AboutUsBannerOverlayElement = styled.div`
  position: absolute;
  inset: 0;
  z-index: 1;
  background:
...
export const AboutUsBannerInnerElement = styled(SectionContainer)`
  position: relative;
  z-index: 2;
  display: flex;
  align-items: center;
...
export const AboutUsBannerContentElement = styled.div`
  display: flex;
...
export const AboutUsBannerTitleElement = styled.h1`
  max-width: 28ch;
...
export const AboutUsBannerTextElement = styled.p`
  max-width: 52ch;
  color: ${({ theme }) => theme.color.background.primary};
