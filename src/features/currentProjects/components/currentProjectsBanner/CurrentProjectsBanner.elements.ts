...
export const CurrentProjectsBannerElement = styled.section`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
...
export const CurrentProjectsBannerMediaElement = styled.img`
  position: absolute;
  inset: 0;
  width: 100%;
  height: 100%;
...
export const CurrentProjectsBannerOverlayElement = styled.div`
  position: absolute;
  inset: 0;
  z-index: 1;
  background:
...
export const CurrentProjectsBannerInnerElement = styled(SectionContainer)`
  position: relative;
  z-index: 2;
  display: flex;
  align-items: center;
...
export const CurrentProjectsBannerContentElement = styled.div`
  display: flex;
...
export const CurrentProjectsBannerTitleElement = styled.h1`
  max-width: 28ch;
...
export const CurrentProjectsBannerTextElement = styled.p`
  max-width: 42ch;
  color: ${({ theme }) => theme.color.background.primary};
